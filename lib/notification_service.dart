  ...
  NotificationDetails _details({bool asAlarm = false}) {
    return NotificationDetails(
      android: AndroidNotificationDetails(
        ...
        // real alarm: they use the alarm category and a full-screen
        // intent so they wake the device and show over the lock screen,
        // instead of behaving like a normal, easy-to-miss notification.
        category: asAlarm
